...
public class PantallaCargarIndicador extends JFrame {
	...
	public PantallaCargarIndicador(JFrame fatherWindow, ArrayList<Cuenta> cuentasGlobales) {
		setUndecorated(true);
		PantallaCargarIndicador wind= this;
