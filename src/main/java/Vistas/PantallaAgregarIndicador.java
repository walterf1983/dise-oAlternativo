...
public class PantallaAgregarIndicador extends JFrame {
	...
	public static void setPosY(int posY) {
		PantallaAgregarIndicador.posY = posY;
	}
	...
	public static void setCountInstance(int countInstance) {
		PantallaAgregarIndicador.countInstance = countInstance;
	}
	...
	public PantallaAgregarIndicador(JFrame fatherWindow) {
		...
		botonSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(fatherWindow.getClass().getName().equalsIgnoreCase("vistas.pantallacuentas")){
					...
					PantallaAgregarIndicador.setPosY(wind.getY());
		...
		private void posicionarPantalla(JFrame fatherWindow){
			...
			if(PantallaAgregarIndicador.countInstance==1){
				this.setBounds(posRX+450,posRY,450,273);
				PantallaAgregarIndicador.setPosY(posRY+273);
			}else{
				this.setBounds(posRX+450,PantallaAgregarIndicador.getPosY(),450,273);
			}
			setVisible(true);
		}
